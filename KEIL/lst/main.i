...
void SYS_Init(void)
{
  ...
  ((CLK_T *) (((uint32_t)0x40000000) + 0x00200UL))->CLKSEL1 |= (0b00 << 24); // Set to HXT
...
void UART0_Config(void)
{
  ...
  // Pin configuration
  // ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)).12 (RX) --> Input ; ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)).13 (TX) --> output
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->MODE &= ~(0b11 << 24); // ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)).12 as input

  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->MODE &= ~(0b11 << 26); // clear setting ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)).13
  ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL))->MODE |= (0b01 << 26); // ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)).13 as output push-pull mode

  // Set ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)) Multi-function pins for ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)) RXD and TXD
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPH &= ~ ((0xF << 16) | (0xF << 20)); // Clear current settings ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)).12 -> [19:16]; ((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)).13 [23:20]
  ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPB_MFPH |= ( (6 << 16) | (6 << 20) ); // ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)) - MFP6
  ...
  ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->BAUD &= ~((0b11 << 28) | (0xF << 24) | (0xFFFF << 0)); // clear the current bits

  ((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->BAUD |= ((0b10 << 28) // set to mode 1
...
void Joystick_Polling_Read(void) {
  ...
  static uint8_t down_debounce = 0;
    ...
    if (!(((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL))->PIN & (1 << 2))) {
        if (!up_debounce) {
            volatile uint32_t i;
    ...
    if (!(((GPIO_T *) (((uint32_t)0x40000000) + 0x04180UL))->PIN & (1 << 4))) { // Right pressed
        if ((millis - lastRightTime) > 200 // Same as up/down) {
            MoveTetrominoRight();
    ...
    if (!(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->PIN & (1 << 9))) { // Left pressed
        if ((millis - lastLeftTime) > 200 // Same as up/down) {
            MoveTetrominoLeft();
            lastLeftTime = millis;
        }
    }
    ...
    if (!(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->PIN & (1 << 10))) {
        if (!down_debounce) {
            volatile uint32_t i;
            for (i = 0; i < 10000; i++);
            if (!(((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->PIN & (1 << 10))) {
  ...
  ((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))->CTL &= ~(1 << 30);
    ...
    while (1) {
       ...
       case READY_SCREEN:
         ...
         LCD_BlankArea(0, 0, 240 // LCD Width at pixels, 320 // LCD Hight at pixels, 0x0000); // Full black screen
         LCD_PutString(50, 100, (uint8_t *)"Press SW1 to Start", 0xFFFF, 0x0000);
        ...
        enableTimer();
            ...
            case PAUSED:
                //LCD_PutString(50, 100, (uint8_t *)"PAUSED - Press SW1", 0xFFFF, 0x0000);
                if (switchPressed) {
                    currentState = PLAYING;
                    switchPressed = 0;
                    // Resume timers
        ...
        disableTimer();
                ...
                LCD_PutString(50, 100, (uint8_t *)"GAME OVER - Press SW1", 0xFFFF, 0x0000);
                if (switchPressed) {
                    SaveHighScore(score);
